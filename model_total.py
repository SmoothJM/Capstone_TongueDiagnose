...
#%%
def run_model(q,model_name,n_iter,l_r,opt,transfer_mode,dropout_rate,x_healthy,y_healthy,x_diabete,y_diabete):
#    print("I am 16")
    l2 = 0.01
    K.clear_session()
...
#    print(model_name)
    if model_name is "VGG16":
        ...
        base_model =DenseNet121(weights='imagenet',
                                  include_top=False,
                                  input_shape=shape)
    elif model_name is "InceptionResNetV2":
...
#        base_model_name = "vgg16_64_dropout_32_dropout_16_dropout_1"
    ...
    if opt=="adam":
        ...
        diabete_model.compile(optimizer = adam,
                      loss = "is_categorical_crossentropy", metrics = ["accuracy"])
    elif opt=="sgd":
